...
parsed = io.open(parsed_file_name, "r", encoding='utf8')

foutnm = os.path.splitext(sys.argv[2])[0]

out_file = io.open(outputfolder + foutnm + ".txt", "w", encoding='utf8')
...
def getTenseEN(chain_dict):
    ...
    def deriveTMEN(pos_seq, fin, chain_dict):
        ...
        def getTenseFromVPinfo(pos_seq, vp):
            ...
            #David edit - correcting for problem with will/shall be
                #line 310 says that if you have curr_pos of VB and curr_verb includes "be"
                #then you should tag as 'aux_be_pass' because it thinks be is just a helper
                #for a future passive statement. I think they have forgotten just "it will be"
                #seems to work, now do it for other modal verbs
            elif vp['fut_mod'] and vp['aux_be_pass']:
                tense = "futureI" 
                mood = "indicative"
                voice = "active"    
            ...
            #David edit2 - correcting for problem with would/could/should be
            elif vp['subj_mod'] and vp['aux_be_pass']:
                tense = "condI"
                mood = "subjunctive"
                voice = "active"
            ...
            #David edit3 - correcting for problem with can be, and other remaining modals
            elif vp['mod'] and vp['aux_be_pass']:
                tense = "pres"
                mood = "indicative"
                voice = "active" 
