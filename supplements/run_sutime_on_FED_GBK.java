...
public class run_sutime_on_FED_GBK {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (File file : files) {
            ...
            String write_name_str = String.valueOf(file.getName()).substring(0, 25);
            ...
            String name_str_1 = String.valueOf(file.getName()).substring(4, 8); // year
            String new_name_str = name_str_1;
            String name_str_2 = String.valueOf(file.getName()).substring(8, 10); // month
            new_name_str = new_name_str + "-" + name_str_2;
            String name_str_3 = String.valueOf(file.getName()).substring(10, 12); // day
            new_name_str = new_name_str + "-" + name_str_3;
