...
vfeat = io.open(vfeat_file_name, "r", encoding='utf8')

vfeat_file_name = os.path.splitext(sys.argv[4])[0]

parsed_file = io.open(parsed_file_name, "r", encoding='utf8')
out_file = io.open(vfeat_file_name + ".html", "w", encoding='utf8')
...
# ROB EDIT
# long sentences imply we run out of colours, just re-start the colors again...
colors = colors*20
