...
public class run_sutime_on_speeches {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (File file : files) {
            ...
            //FileWriter myWriter = new FileWriter("C:\\Users\\Dave\\Documents\\Communications\\core-nlp-example\\src\\test\\output\\" + file.getName(), true);
            ...
            String write_name_str = String.valueOf(file.getName()).substring(0, 17);
            ...
            String name_str = String.valueOf(file.getName()).substring(4, 14);
            String new_name_str = name_str.replace("_", "-");
